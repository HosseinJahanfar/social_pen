...
class SolidColors {
  ...
  static const Color selecctedPodCast = Color.fromARGB(255, 255, 139, 26);
  ...
  static const Color seeMore = Color.fromARGB(255, 30, 107, 184);
...
class GradiantColors {
  ...
  ]; static const List<Color> bottomBackground = [
